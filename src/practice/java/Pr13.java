...
public class Pr13 {
    ...
    public static void main(String[] args) {
        ...
        Attackablee attackable = new Swordd();
        Characterr.useWeapon(attackable);
        ...
        Object oduck = new Duck();
        if(oduck instanceof Flyable){
            Flyable Fduck = (Flyable)oduck;
            Fduck.fly();
        }
        if(oduck instanceof Swimmable){
            Swimmable Sduck = (Swimmable)oduck;
            Sduck.swim();
        }
        ...
        Televisionn t1 = new Televisionn();
        t1.turnOn();
        t1.turnOff();
        t1.setMute(false);
...
interface Soundable{
        ...
        class Catt implements Soundable{
            @Override public void makeSound(){System.out.println("야옹");};
        }
        class Dogg implements Soundable{
...
interface Attackablee{
    public void attack();


}

class Swordd implements Attackablee{
...
class Gunn implements Attackablee{
...
class Characterr{
    ...
    public static void useWeapon(Attackablee weapon){
        weapon.attack();
    }
}
...
class Televisionn implements Devicee{
    @Override
    public void turnOn(){
