...
public class Pr12 {
    public static void main(String[] args) {
        ...
        Triangle t1 = new Triangle();  //Triangle를 선언할 때 둘다 실행되어 타입 변환을 할 수 있다.
        Figure t2 = t1;    
        ...
        Shape shape = new Circle();     //Shape 타입 변수에 Circle 생성자의 객체가 참조되지만 결국 내용은 Circle 이기때문에 "원을 그립니다." 출력
        shape.draw();
        ...
        if(l1 instanceof Electronic){
            System.out.println("변환 가능");
        }

        if(l1 instanceof Device){
            System.out.println("변환 가능");
        }
