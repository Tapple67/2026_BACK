...
System.out.println("제 이름은 "+ name + ", 나이는 "+ age1 + ", 키는 "+ height + " 입니다");
...
// System.out.printf("%s 님의 나이는 %d세 입니다", name8,age8);
...
System.out.println("성별을 입력하세요(남/여):");  char 성별= scanner.next().charAt(0);
...
double height11 = scanner.nextDouble();
System.out.println("프로그래머 입니까(true/false):");
boolean pro = scanner.nextBoolean();

System.out.printf("---자기소개---\n이름:%s\n나이:%d\n키:%.1f\n프로그래머 여부:%b",
    name11,age11,height11,pro
);
